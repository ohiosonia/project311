...
interactions_df.registerTempTable("complaint_types")

complaints = sqlContext.sql("""
    SELECT distinct complaint_type FROM complaint_types
""")
...
complaints.write.format("org.apache.spark.sql.cassandra").options(table ="complaint_types", keyspace = "playground").save(mode='append')
